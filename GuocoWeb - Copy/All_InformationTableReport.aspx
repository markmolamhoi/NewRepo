<%@ Page Language="C#" AutoEventWireup="true" CodeFile="All_InformationTableReport.aspx.cs" Inherits="All_InformationTableReport" %>
            ...
            <ContentTemplate>
                <div id="divData" runat="server">
                    ...
                    <div id="divSalesDetail" runat="server" class="panel panel-primary">
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-condensed table-hover table-bordered" AllowPaging="true" AutoGenerateColumns="True" RowStyle-Wrap="false" PageSize="200" OnRowDataBound="GridView1_RowDataBound" >
                        </asp:GridView>
                    </div>
                </div>
            </ContentTemplate>
