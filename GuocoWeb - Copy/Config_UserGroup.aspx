<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Config_UserGroup.aspx.cs" Inherits="Config_UserGroup" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <asp:UpdatePanel ID="upDetail" runat="server">
            <ContentTemplate>
                <asp:Button ID="btnInsert" runat="server" Text="Add UserGroup Profile" OnClick="btnInsert_AddUserGroupProfile_Click" class="btn btn-info" />
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-condensed table-hover table-bordered" AllowPaging="true" AutoGenerateColumns="True" RowStyle-Wrap="true" PageSize="50" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" >
                            <Columns>
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblKey_Header" runat="server" Text='<%# Eval("UserGroupCode")%>' Visible="false"> </asp:Label>
                ...
                <div id="div_UserGroupProfile" runat="server" class="divPopUpPanel">
                    <div runat="server" class="panel panel-primary">
                        ...
                        <table class="table table-condensed table-hover">
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label7" runat="server" Text="UserGroup Code"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtUserGroupCode" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label14" runat="server" Text="UserGroup Short Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtUserGroupShortName" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label3" runat="server" Text="UserGroup Full Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtUserGroupFullName" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnUpdate_UserProfile" runat="server" Text="Edit"
                                        class="btn btn-info btn-block" OnClick="btnUpdate_UserProfile_Click" Width="80px" />
                ...
                <cc1:AlwaysVisibleControlExtender ID="AlwaysVisibleControlExtender3" runat="server"
                    TargetControlID="div_UserGroupProfile" VerticalSide="Middle" HorizontalSide="Center" ScrollEffectDuration=".1" />
