<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Config_Division.aspx.cs" Inherits="Config_Division" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <ContentTemplate>
                    <div class="panel panel-primary">
                        ...
                        <table class="table table-condensed table-hover">
                            <tr>
                                <th class="width20">
                                    <asp:Label ID="Label1a" runat="server" Text="Company Code:"></asp:Label>
                                </th>
                              <td>
                                    <cc2:SmartDropDownList ID="ddlCompanyCode" runat="server" CssClass="selectpicker selectwidthauto">
        ...
        <asp:UpdatePanel ID="upDetail" runat="server">
            <ContentTemplate>
                <asp:Button ID="btnInsert" runat="server" Text="Add Division" OnClick="btnInsert_AddDivision_Click" class="btn btn-info" />
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-condensed table-hover table-bordered" AllowPaging="true" AutoGenerateColumns="True" RowStyle-Wrap="true" PageSize="50" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:Button ID="btnEidtInfo" runat="server" Text="Edit Division" class="btn btn-info" CommandName="Edit1" CommandArgument='<%# Container.DataItemIndex %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblKey_Header" runat="server" Text='<%# Eval("DivisionCode")%>' Visible="false"> </asp:Label>
                ...
                <div id="divPopUpPanel" runat="server" class="divPopUpPanel">
                    <div runat="server" class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            ...
                            <asp:Label ID="Label6" runat="server" Text="Edit  Info" Font-Bold="True"></asp:Label>
                        </div>

                        <table class="table table-condensed table-hover">
                             <tr>
                                <th class="width30">
                                    <asp:Label ID="Label7a" runat="server" Text="Division Code"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtDivisionCode" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr> 
                               <tr>
                                <th class="width30">
                                ...
                                <td>
                                    <cc2:SmartDropDownList ID="ddlCompanyCode_edit" runat="server" class="form-control" AutoPostBack="true" >
                                    </cc2:SmartDropDownList>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label14" runat="server" Text="Division Short Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtDivisionShortName" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label3" runat="server" Text="Division Full Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtDivisionFullName" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
