<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Config_FolderPost.aspx.cs" Inherits="Config_FolderPost" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upDetail" runat="server">
            <ContentTemplate>
                <asp:Button ID="btnInsert" runat="server" Text="Add Post" OnClick="btnInsert_AddFolder_Click" class="btn btn-info" />
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-condensed table-hover table-bordered" AllowPaging="true" AutoGenerateColumns="True" RowStyle-Wrap="true" PageSize="50" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:Button ID="btnEidtInfo" runat="server" Text="Edit Post" class="btn btn-info" CommandName="Edit1" CommandArgument='<%# Container.DataItemIndex %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Link">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server"
                                            NavigateUrl='<%# LIBLocal.sLoadPostURL(Eval("URL").ToString(), Eval("PostCode").ToString(), Eval("FolderCode").ToString())%>'
                                            Target="_blank" Text="View Post"></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblKey_Header" runat="server" Text='<%# Eval("PostCode")%>' Visible="false"> </asp:Label>
                    ...
                    <div runat="server" class="panel panel-primary">
                        ...
                        <table class="table table-condensed table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc2:SmartTextbox ID="txtSubject" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>   
                            <tr>
                                <th class="width30">
                                ...
                                <td>
                                    ...
                                    <cc2:SmartTextbox ID="DPDate" runat="server" MaxLength="10" onkeypress="return isNumber(event)"  ></cc2:SmartTextbox>
                                        <asp:ImageButton ID="ImageButton1" ImageUrl="img/calendar.png" ImageAlign="Bottom" runat="server" />
                                        <cc1:CalendarExtender ID="CalendarExtender1"  PopupButtonID="ImageButton1" runat="server" TargetControlID="DPDate" 
                                        Format="yyyy-MM-dd" >
                            ...
                            <tr>
                                ...
                                <td>
                                    <%--<asp:Label ID="lbl_UserCode" runat="server" ></asp:Label>--%>
                                    <cc2:SmartTextbox ID="txtSuperUser" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                ...
                                <td>
                                    <cc2:SmartTextbox ID="txtOwnerBy" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>                            
                             <tr>
                                <th class="width30">
                             ...
                             <tr>
                                ...
                                <td>
                                    <cc2:SmartTextbox ID="txtDistribution" runat="server" class="form-control" Width="350px" TextMode="MultiLine" Rows="3"></cc2:SmartTextbox>
                                </td>
                            </tr>
                             <tr>
                                <th class="width30">
                                ...
                                <td>
                                    <cc2:SmartTextbox ID="txtDetail" runat="server" class="form-control" Width="350px" TextMode="MultiLine" Rows="3"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                            ...
                            <tr>
                                ...
                                <td>
                                    <cc2:SmartTextbox ID="txtSorting" runat="server" class="form-control" Width="350px" onkeypress="return isNumber(event)"  ></cc2:SmartTextbox>
                                </td>
                            </tr>
                             <tr>
                                <th class="width30">
                             ...
                             <tr>
                                <th class="width30">
                                    <asp:Label ID="Label8" runat="server" Text="URL Target"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtURLTarget" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
