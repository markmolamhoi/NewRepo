<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Config_Company.aspx.cs" Inherits="Config_Company" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upDetail" runat="server">
            <ContentTemplate>
                <asp:Button ID="btnInsert" runat="server" Text="Add Company" OnClick="btnInsert_AddCompany_Click" class="btn btn-info" />
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-condensed table-hover table-bordered" AllowPaging="true" AutoGenerateColumns="True" RowStyle-Wrap="true" PageSize="50" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:Button ID="btnEidtInfo" runat="server" Text="Edit Company" class="btn btn-info" CommandName="Edit1" CommandArgument='<%# Container.DataItemIndex %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblKey_Header" runat="server" Text='<%# Eval("CompanyCode")%>' Visible="false"> </asp:Label>
                ...
                <div id="divPopUpPanel" runat="server" class="divPopUpPanel">
                    <div runat="server" class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            ...
                            <asp:Label ID="Label6" runat="server" Text="Edit Company Info" Font-Bold="True"></asp:Label>
                        </div>

                        <table class="table table-condensed table-hover">
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label7" runat="server" Text="Company Code"></asp:Label>
                                </th>
                                <td>
                                    <%--<asp:Label ID="lbl_UserCode" runat="server" ></asp:Label>--%>
                                    <cc2:SmartTextbox ID="txtCompanyCode" runat="server" class="form-control" Width="350px" MaxLength="50"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label14" runat="server" Text="Company Short Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtCompanyShortName" runat="server" class="form-control" Width="350px" MaxLength="50"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label3" runat="server" Text="Company Full Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtCompanyFullName" runat="server" class="form-control"  MaxLength="200"></cc2:SmartTextbox>
                                </td>
                            </tr>
                           
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label1" runat="server" Text="Min. Password length"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtMinPasswordlength" runat="server" class="form-control" Width="200px" onkeypress="return isNumber(event)" Text="8" MaxLength="2"></cc2:SmartTextbox>
                                </td>
                            </tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <cc2:SmartTextbox ID="txtRemark" runat="server" class="form-control"  TextMode="MultiLine" Rows="2" MaxLength="300"></cc2:SmartTextbox>
                                </td>
                            </tr>

                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label16" runat="server" Text="2nd Approver"></asp:Label>
                                </th>
                                <td>
                                     <cc2:SmartDropDownList ID="ddl2ndApprover" runat="server" class="form-control" >
                            ...
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label2" runat="server" Text="3rd Approver"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartDropDownList ID="ddl3rdApprover" runat="server" class="form-control" >
                                    </cc2:SmartDropDownList>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label4" runat="server" Text="4th Approver"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartDropDownList ID="ddl4thApprover" runat="server" class="form-control" >
                                    </cc2:SmartDropDownList>
                                </td>
                            </tr>
