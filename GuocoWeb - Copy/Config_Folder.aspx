<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Config_Folder.aspx.cs" Inherits="Config_Folder" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upDetail" runat="server">
            <ContentTemplate>
                <asp:Button ID="btnInsert" runat="server" Text="Add Folder" OnClick="btnInsert_AddFolder_Click" class="btn btn-info" />
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-condensed table-hover table-bordered" AllowPaging="true" AutoGenerateColumns="True" RowStyle-Wrap="true" PageSize="50" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="50px">
                                    <ItemTemplate>
                                        <asp:Button ID="btnEidtInfo" runat="server" Text="Edit Folder" class="btn btn-info" CommandName="Edit1" CommandArgument='<%# Container.DataItemIndex %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblKey_Header" runat="server" Text='<%# Eval("FolderCode")%>' Visible="false"> </asp:Label>
                ...
                <div id="divPopUpPanel" runat="server">
                    <div runat="server" class="panel panel-primary">
                        ...
                        <table class="table table-condensed table-hover">
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label7" runat="server" Text="Folder Code"></asp:Label>
                                </th>
                                <td>
                                    <%--<asp:Label ID="lbl_UserCode" runat="server" ></asp:Label>--%>
                                    <cc2:SmartTextbox ID="txtFolderCode" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label14" runat="server" Text="Folder Short Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtFolderShortName" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                            <tr>
                                <th class="width30">
                                    <asp:Label ID="Label3" runat="server" Text="Folder Full Name"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartTextbox ID="txtFolderFullName" runat="server" class="form-control" Width="350px"></cc2:SmartTextbox>
                                </td>
                            </tr>
                             <tr>
                                <th class="width30">
                                    <asp:Label ID="Label8" runat="server" Text="System"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartDropDownList ID="ddlSystemCode_edit" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlSystemCode_edit_SelectedIndexChanged" >
                                    </cc2:SmartDropDownList>
                                </td>
                            </tr>
                             <tr>
                                <th class="width30">
                                    <asp:Label ID="Label4" runat="server" Text="Parent Folder"></asp:Label>
                                </th>
                                <td>
                                    <cc2:SmartDropDownList ID="ddlParentFolderCode_edit" runat="server" class="form-control" AutoPostBack="true" >
                                    </cc2:SmartDropDownList>
                                </td>
                            </tr>
                            <tr>
