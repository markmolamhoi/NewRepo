...
public partial class All_InformationTableReport : System.Web.UI.Page
{
    ...
    {
        this.lblReportName.Text = this.ddlReportRowOption.SelectedItem.Text;
        ...
        ClsLoadFieldHelper.fAddSqlParameter("DateFrom", DateFrom.Text);
        ClsLoadFieldHelper.fAddSqlParameter("DateTo", DateTo.Text);

        //ClsLoadFieldHelper.fBuildDataSet("stp_wf_rss_Sales_GridInformationTable");
       ...
       if (lblChart_ConnectOracle.Text == "Y")
        ...
        ClsLoadFieldHelper.fBindGridView(GridView1);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            ...
            {
                if (GridView1.Rows[1].Cells[1].Text.StartsWith("FilePath:") == true)
                {
        ...
        try
        {
            if (e.Row.Cells[1].Text.StartsWith("FilePath:") == true)
            {
                e.Row.Cells[0].Text = LSLIBWebBased.LIBWebBased.sURLHTML(e.Row.Cells[1].Text.Replace("FilePath:", ""), e.Row.Cells[0].Text);
